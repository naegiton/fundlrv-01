...
<div class="form-group has-success">
      ...
      <div class="col-sm-10">
               <input type="text" class="form-control" name="fundname" placeholder="fundidd" value="{{ App\fundtype::namefund(Request::input('fundid')) }}">
...
<div class="form-group has-success">
      ...
      <div class="col-sm-10">
               <input type="text" class="form-control" name="idoffice" placeholder="idoffice" value="{{ '0000' }}">
